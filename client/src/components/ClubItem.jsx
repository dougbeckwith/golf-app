  ...
  return (
    <>
      <div
        ...
        className="text-gray-200 flex flex-col w-full rounded-md  mb-2 bg-dark-400 items-center justify-between hover:bg-dark-200 hover:cursor-pointer px-2">
        ...
        <div
          ...
          className={`mr-auto bg-gradient-to-r from-dark-200 to-blue-100 rounded-full h-4 mb-1 dark:bg-gray-700`}></div>
      </div>
    </>
  );
};

  ...
  return (
    <div className="h-screen flex justify-center items-center">
      {isLoading ? (
        ...
        <>
          <div className="text-center text-gray-100  mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <h1 className="mx-auto max-w-4xl font-display text-4xl font-medium tracking-tight text-slate-900 sm:text-5xl md:7xl">
              ...
              <span className="relative whitespace-nowrap">
                ...
                <span className="relative text-blue-300">made simple</span>
              </span>{" "}
              for golfers.
            </h1>
            <p className="pt-5 lg:pt-10 mx-auto mt-6 max-w-2xl  lg:text-lg tracking-tight text-gray-200">

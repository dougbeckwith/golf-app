...
const Landing = () => {
  ...
  const handleDemoSignIn = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) handleDemoSignInSuccess();
      else handleDemoSignInError(response);
    ...
    <div className="bg-dark-500 h-screen flex justify-center items-center">
      <div className="pt-20 pb-16 text-center text-gray-400 lg:pt-32 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <p className="pt-10 mx-auto mt-6 max-w-2xl text-lg tracking-tight text-gray-500">
          Play the game your way. Easily track your golf data to remove strokes from your game. Dive
          deep into your golf game.
        </p>
        ...
        <Link to="/clubs">
          <button
            ...
            className="mt-10 px-4 py-2 md:px-7 text-sm font-medium rounded-md shadow-sm text-dark-400 bg-gray-400 hover:bg-gray-400">
            Demo
          </button>
        </Link>
      </div>
